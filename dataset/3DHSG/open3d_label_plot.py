...
for scanid, content in contents.items():
    ...
    # import numpy as np
    # # o3d.visualization.gui.Initialize()
    # # o3d.visualization.gui.Window()
    # # Create an O3DVisualizer object (optional, if you want to visualize the label)
    # # visualizer = o3d.visualization.O3DVisualizer()

    # # Define the 3D coordinates where you want to anchor the label
    # coordinates = np.array([1,2,3])  # Replace x, y, z with your desired coordinates

    # # Create a 3D label with the desired text and position
    # label_text = "Hello, 3D World!"  # Replace with your desired label text
    # label = o3d.visualization.gui.Label3D(label_text, coordinates)

    # # Add the label to your scene (assuming you have a SceneWidget)
    # scene_widget = o3d.visualization.gui.SceneWidget()
    # # Add the label to the visualizer (optional, if you want to visualize it)
    # scene_widget.add_3d_label(coordinates, label_text)
    # # export DISPLAY=localhost:0.0
    # # Display the scene (optional, if you want to visualize the label)
    # # scene_widget.run()
    # # Display your scene with the added label
    # o3d.visualization.draw_geometries([scene_widget])

    # import open3d as o3d
    # import numpy as np

    # # Create a 3D label with text "Hello, Open3D!" at position (x, y, z)
    # label_text = "Hello, Open3D!"
    # label_position = np.array([x, y, z])
    # label = o3d.visualization.gui.Label3D(label_text, label_position)

    # # Add the label to your scene (assuming you have a SceneWidget)
    # scene_widget = o3d.visualization.gui.SceneWidget()
    # scene_widget.add_3d_label(label_position, label_text)
