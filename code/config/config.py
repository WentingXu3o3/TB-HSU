...
class GetConfig:
    ...
    @property
    def scanname(self):
        return self.__getattr__("scanname")
    ...
    @property
    def lr(self):
        return self.__getattr__("lr")

    @property
    def mm(self):
        return self.__getattr__("mm")
    
    @property
    def wd(self):
        return self.__getattr__("wd")

    @property
    def num_epochs(self):
        return self.__getattr__("num_epochs")

    @property
    def batch_size(self):
        return self.__getattr__("batch_size")

    @property
    def use_axis(self):
        return self.__getattr__("use_axis")

    @property
    def num_points(self):
        return self.__getattr__("num_points")
    ...
    @property
    def text_embedding_context_length(self):
        return self.__getattr__("text_embedding_context_length")

    @property
    def text_embedding_layers(self):
        return self.__getattr__("text_embedding_layers")
    ...
    def random_seed(self):
        return self.__getattr__("random_seed")
    ...
    @property
    def baseline_is(self):
        return self.__getattr__("baseline_is")

    @property
    def baseline_model(self):
        return self.__getattr__("baseline_model")
    
    @property
    def text_tokenized_model(self):
        return self.__getattr__("text_tokenized_model")
    ...
    @property
    def RegetData(self):
        return self.__getattr__("RegetData")

    @property
    def SE_type(self):
        return self.__getattr__("SE_type")
